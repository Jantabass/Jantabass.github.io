...
document.getElementById("footer").innerHTML = `
  <footer>
    <p>© 2026 ClearPhone</p>
    <ul>
      <li><a class="translate-aboutUs" href="${getBasePath()}html/omOss.html">Om oss</a></li>
      <li><a class="translate-contactUs" href="${getBasePath()}html/kontaktOss.html">Kontakt oss</a></li>
...
const translations = {
  no: {
    ...
    email: "E-post",
    phone: "Telefon",
    sendMsg: "Send oss melding direkte",
    sendMsgBtn: "Send melding",
  ...
  en: {
    ...
    email: "Email",
    phone: "Phone",
    sendMsg: "Send message here directly",
